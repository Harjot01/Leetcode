...
int equalStacks(vector<int>& h1, vector<int>& h2, vector<int>& h3) {
    ...
    for (int height : h1) h1_height += height;
    for (int height : h2) h2_height += height;
    for (int height : h3) h3_height += height;

    // Perform the removals until the stacks have the same height
    ...
    return h1_height;  // Return any of the three heights, as they are equal now
}
